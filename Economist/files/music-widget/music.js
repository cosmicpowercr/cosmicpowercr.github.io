...
function musicload() {
    ...
    document.body.appendChild(videof);
    // videoBox.appendChild(videof);
    // // 盒子转动
    // // videof.style = 'animation: rotate 5s linear infinite;';
    // // 创建video
    // videof.innerHTML = `<audio id="mp3" src="${musicList[nowMusic]}"  ></audio>`;
    ...
    g_btmbar.innerHTML =
        `
        <audio id="mp3" src="${musicList[nowMusic]}"  ></audio>
        ...
        <div class="wrap" id="g_player" style="margin-left: -498.5px;">
            <div class="btns">
                ...
                <a href="javascript:;" hidefocus="true" data-action="play" class="ply j-flag pas" title="播放/暂停(p)">播放/暂停</a>
                <a href="javascript:;" hidefocus="true" data-action="next" class="nxt" title="下一首(ctrl+→)">下一首</a>
            </div>
            <div class="head j-flag"><img id="musicImg" src="../../../music-widget/images/bg1.jpg">
    ...
    nxt.addEventListener('click', function() {
            ...
            window.location.href= "../" + musicnames[nowMusic]["uid"] + "/index.html"
            console.log("now:",musicList[nowMusic]);
        })
        // 上一首
...
function replaceMusic(path) {
    ...
    // if (ply.className.indexOf('pas') != -1) {
    //     video.play();
    // } else {
    //     video.pause();
    // }
